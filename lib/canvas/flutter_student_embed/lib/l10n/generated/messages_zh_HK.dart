...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static m0(points) => "${points} 分";

  static m1(courseName) => "${courseName} 待辦事項";

  static m2(date, time) => "日期 ${date}，時間 ${time}";

  static m3(date, time) => "截止於 ${date} 的 ${time}";

  static m4(month) => "下個月：${month}";

  static m5(date) => "下一週開始 ${date}";

  static m6(points) => "可能的分數 ${points}";

  static m7(month) => "上個月：${month}";

  static m8(date) => "上一週開始 ${date}";

  static m9(month) => "${month} 的月份";
  ...
  static _notInlinedMessages(_) => <String, Function> {
    ...
    "Are You Sure?" : MessageLookupByLibrary.simpleMessage("您是否確定？"),
    "Are you sure you wish to close this page? Your unsaved changes will be lost." : MessageLookupByLibrary.simpleMessage("是否確定要關閉此頁面？您的未保存變更都將丟失。"),
    "Calendar" : MessageLookupByLibrary.simpleMessage("行事曆"),
    "Calendars" : MessageLookupByLibrary.simpleMessage("行事曆"),
    "Cancel" : MessageLookupByLibrary.simpleMessage("取消"),
    "Course (optional)" : MessageLookupByLibrary.simpleMessage("課程（可選）"),
    ...
    "Do you want to delete this To Do item?" : MessageLookupByLibrary.simpleMessage("是否要刪除此待辦事項？"),
    "Done" : MessageLookupByLibrary.simpleMessage("已完成"),
    "Edit" : MessageLookupByLibrary.simpleMessage("編輯"),
    "Edit To Do" : MessageLookupByLibrary.simpleMessage("編輯待辦事項"),
    ...
    "New To Do" : MessageLookupByLibrary.simpleMessage("新待辦事項"),
    ...
    "There was an error deleting this To Do. Please check your connection and try again." : MessageLookupByLibrary.simpleMessage("刪除此待辦事項時出錯。請檢查您的連接然後重試。"),
    "There was an error loading your calendar" : MessageLookupByLibrary.simpleMessage("載入您的行事曆時發生錯誤"),
    "There was an error loading your your student’s courses." : MessageLookupByLibrary.simpleMessage("載入您的學生的課程時發生錯誤。"),
    "There was an error saving this To Do. Please check your connection and try again." : MessageLookupByLibrary.simpleMessage("保存此待辦事項時出錯。請檢查您的連接然後重試。"),
    "There's no description yet" : MessageLookupByLibrary.simpleMessage("尚未有描述說明"),
    "Title" : MessageLookupByLibrary.simpleMessage("標題"),
    "Title must not be empty" : MessageLookupByLibrary.simpleMessage("不可留空標題"),
    "To Do" : MessageLookupByLibrary.simpleMessage("待辦事項"),
