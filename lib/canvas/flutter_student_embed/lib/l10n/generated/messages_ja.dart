...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static m0(points) => "${points} 点";

  static m1(courseName) => "${courseName}  To Do";

  static m2(date, time) => "${date}、${time}";

  static m3(date, time) => "${date}、${time} 期限";

  static m4(month) => "来月：${month}";

  static m5(date) => "${date} から始まる翌週";

  static m6(points) => "${points} の可能なポイント";

  static m7(month) => "前月：${month}";

  static m8(date) => "${date} から始まる前週";

  static m9(month) => "${month} 月";
  ...
  static _notInlinedMessages(_) => <String, Function> {
    ...
    "Are You Sure?" : MessageLookupByLibrary.simpleMessage("ほんとうに実行しますか？"),
    "Are you sure you wish to close this page? Your unsaved changes will be lost." : MessageLookupByLibrary.simpleMessage("このページを閉じてもよろしいですか？保存されていない変更はすべて失われます。"),
    "Calendar" : MessageLookupByLibrary.simpleMessage("予定表"),
    "Calendars" : MessageLookupByLibrary.simpleMessage("予定表"),
    "Cancel" : MessageLookupByLibrary.simpleMessage("キャンセル"),
    "Course (optional)" : MessageLookupByLibrary.simpleMessage("コース（オプション）"),
    ...
    "Do you want to delete this To Do item?" : MessageLookupByLibrary.simpleMessage("この To Do アイテムを削除しますか？"),
    "Done" : MessageLookupByLibrary.simpleMessage("終了"),
    "Edit" : MessageLookupByLibrary.simpleMessage("編集"),
    "Edit To Do" : MessageLookupByLibrary.simpleMessage("To Do を編集"),
    ...
    "New To Do" : MessageLookupByLibrary.simpleMessage("新しい To Do"),
    ...
    "There was an error deleting this To Do. Please check your connection and try again." : MessageLookupByLibrary.simpleMessage("この To Do を削除中にエラーが起こりました。接続を確認して、もう一度お試しください。"),
    "There was an error loading your calendar" : MessageLookupByLibrary.simpleMessage("予定表読み込み中にエラーが発生しました"),
    "There was an error loading your your student’s courses." : MessageLookupByLibrary.simpleMessage("受講生のコースのロード中にエラーが発生しました"),
    "There was an error saving this To Do. Please check your connection and try again." : MessageLookupByLibrary.simpleMessage("この To Do を保存中にエラーが起こりました。接続を確認して、もう一度お試しください。"),
    "There's no description yet" : MessageLookupByLibrary.simpleMessage("説明はまだありません"),
    "Title" : MessageLookupByLibrary.simpleMessage("タイトル"),
    "Title must not be empty" : MessageLookupByLibrary.simpleMessage("タイトルが空欄であることはできません"),
    "To Do" : MessageLookupByLibrary.simpleMessage("タスク"),
