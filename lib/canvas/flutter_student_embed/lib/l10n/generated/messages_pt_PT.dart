...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static m1(courseName) => "${courseName} Tarefa";

  static m2(date, time) => "${date} em ${time}";

  static m3(date, time) => "Termina ${date} a ${time}";

  static m4(month) => "Próximo mês: ${month}";

  static m5(date) => "A partir da próxima semana ${date}";

  static m6(points) => "${points} ponto possível";

  static m7(month) => "Mês anterior: ${month}";

  static m8(date) => "A partir da semana anterior ${date}";
  ...
  static _notInlinedMessages(_) => <String, Function> {
    ...
    "Are You Sure?" : MessageLookupByLibrary.simpleMessage("Tem certeza?"),
    "Are you sure you wish to close this page? Your unsaved changes will be lost." : MessageLookupByLibrary.simpleMessage("Tem a certeza de que pretende fechar esta página? Todos os dados não guardados serão perdidos."),
    ...
    "Course (optional)" : MessageLookupByLibrary.simpleMessage("Disciplina (opcional)"),
    "Date" : MessageLookupByLibrary.simpleMessage("Data"),
    "Delete" : MessageLookupByLibrary.simpleMessage("Eliminar"),
    "Description" : MessageLookupByLibrary.simpleMessage("Descrição"),
    "Device model" : MessageLookupByLibrary.simpleMessage("Modelo do dispositivo"),
    "Do you want to delete this To Do item?" : MessageLookupByLibrary.simpleMessage("Tem certeza de que deseja eliminar este item de Tarefa?"),
    "Done" : MessageLookupByLibrary.simpleMessage("Feito"),
    "Edit" : MessageLookupByLibrary.simpleMessage("Editar"),
    "Edit To Do" : MessageLookupByLibrary.simpleMessage("Editar para fazer"),
    ...
    "New To Do" : MessageLookupByLibrary.simpleMessage("Novo para fazer"),
    ...
    "There was an error deleting this To Do. Please check your connection and try again." : MessageLookupByLibrary.simpleMessage("Houve um erro ao eliminar esta Tarefa É favor verificar sua conexão e tente novamente."),
