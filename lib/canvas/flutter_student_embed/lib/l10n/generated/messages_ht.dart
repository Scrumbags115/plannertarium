...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static m0(points) => "${points} pwen";

  static m1(courseName) => "${courseName} Tach";

  static m2(date, time) => "${date} a ${time}";

  static m3(date, time) => "Delè ${date} a ${time}";

  static m4(month) => "Pwochen mwa: ${month}";

  static m5(date) => "Semenn pwochen kòmanse ${date}";

  static m6(points) => "${points} pwen posib";

  static m7(month) => "Mwa pase: ${month}";

  static m8(date) => "Semenn pase kòmanse ${date}";

  static m9(month) => "Mwa ${month}";
  ...
  static _notInlinedMessages(_) => <String, Function> {
    ...
    "Are You Sure?" : MessageLookupByLibrary.simpleMessage("Tout bon ou vle sa?"),
    "Are you sure you wish to close this page? Your unsaved changes will be lost." : MessageLookupByLibrary.simpleMessage("Ou kwè vrèman ou vle fèmen paj sa a? W ap pèdi chanjman ki pa anrejistre yo."),
    ...
    "Course (optional)" : MessageLookupByLibrary.simpleMessage("Kou (opsyonèl)"),
    ...
    "Do you want to delete this To Do item?" : MessageLookupByLibrary.simpleMessage("Èske w vle efase eleman sa a nan Tach la?"),
    "Done" : MessageLookupByLibrary.simpleMessage("Fini"),
    "Edit" : MessageLookupByLibrary.simpleMessage("Modifye"),
    "Edit To Do" : MessageLookupByLibrary.simpleMessage("Chanje Tach"),
    ...
    "New To Do" : MessageLookupByLibrary.simpleMessage("Nouvo Tach"),
    ...
    "There was an error deleting this To Do. Please check your connection and try again." : MessageLookupByLibrary.simpleMessage("Te gen erè pou efase Tach sa a. Tanpri verifye koneksyon ou a epi eseye ankò."),
