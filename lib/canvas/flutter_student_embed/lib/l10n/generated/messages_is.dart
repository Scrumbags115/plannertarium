...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static m0(points) => "${points} punktar";

  static m1(courseName) => "${courseName} Verkefni";

  static m2(date, time) => "${date} klukkan ${time}";

  static m3(date, time) => "Skiladagur ${date} þann ${time}";

  static m4(month) => "Næsti mánuður: ${month}";

  static m5(date) => "Næsta vika hefst ${date}";

  static m6(points) => "${points} punktar mögulegir";

  static m7(month) => "Fyrri mánuður: ${month}";

  static m8(date) => "Fyrri vika hefst ${date}";

  static m9(month) => "${month} mánuði";
  ...
  static _notInlinedMessages(_) => <String, Function> {
    ...
    "Are You Sure?" : MessageLookupByLibrary.simpleMessage("Ertu viss?"),
    "Are you sure you wish to close this page? Your unsaved changes will be lost." : MessageLookupByLibrary.simpleMessage("Viltu örugglega loka þessari síðu? Óvistaðar breytingar munu tapast."),
    ...
    "Course (optional)" : MessageLookupByLibrary.simpleMessage("Námskeið (valfrjálst)"),
    ...
    "Do you want to delete this To Do item?" : MessageLookupByLibrary.simpleMessage("Viltu eyða þessu verkefni?"),
    "Done" : MessageLookupByLibrary.simpleMessage("Lokið"),
    "Edit" : MessageLookupByLibrary.simpleMessage("Breyta"),
    "Edit To Do" : MessageLookupByLibrary.simpleMessage("Breyta verkefni"),
    ...
    "New To Do" : MessageLookupByLibrary.simpleMessage("Nýtt verkefni"),
    ...
    "There was an error deleting this To Do. Please check your connection and try again." : MessageLookupByLibrary.simpleMessage("Villa kom upp við að eyða þessu verkefni. Athugaðu tengingu þína og reyndu aftur."),
