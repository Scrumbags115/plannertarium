...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static m0(points) => "${points} pistettä";

  static m1(courseName) => "${courseName} Tehtävä";

  static m2(date, time) => "${date} kohteessa ${time}";

  static m3(date, time) => "Määräpäivä ${date} kohteessa ${time}";

  static m4(month) => "Seuraava kuukausi: ${month}";

  static m5(date) => "Seuraava viikko alkaen ${date}";

  static m6(points) => "${points} pistettä mahdollista";

  static m7(month) => "Edellinen kuukausi: ${month}";

  static m8(date) => "Edellinen viikko alkaen ${date}";

  static m9(month) => "Kuukausi ${month}";
  ...
  static _notInlinedMessages(_) => <String, Function> {
    ...
    "Are You Sure?" : MessageLookupByLibrary.simpleMessage("Oletko varma?"),
    "Are you sure you wish to close this page? Your unsaved changes will be lost." : MessageLookupByLibrary.simpleMessage("Haluatko varmasti sulkea tämän sivun? Kaikki tallentamattomat muutokset menetetään."),
    ...
    "Course (optional)" : MessageLookupByLibrary.simpleMessage("Kurssi (valinnainen)"),
    ...
    "Do you want to delete this To Do item?" : MessageLookupByLibrary.simpleMessage("Haluatko poistaa tehtäväkohteen?"),
    "Done" : MessageLookupByLibrary.simpleMessage("Valmis"),
    "Edit" : MessageLookupByLibrary.simpleMessage("Muokkaa"),
    "Edit To Do" : MessageLookupByLibrary.simpleMessage("Muokkaa tehtävää"),
    ...
    "New To Do" : MessageLookupByLibrary.simpleMessage("Uusi tehtävä"),
    ...
    "There was an error deleting this To Do. Please check your connection and try again." : MessageLookupByLibrary.simpleMessage("Tämän tehtävän tallennuksessa tapahtui virhe. Tarkasta yhteytesi ja yritä uudelleen."),
    "There was an error loading your calendar" : MessageLookupByLibrary.simpleMessage("Kalenterisi latauksessa ilmeni virhe"),
    ...
    "There was an error saving this To Do. Please check your connection and try again." : MessageLookupByLibrary.simpleMessage("Tehtävän tallennuksessa tapahtui virhe. Tarkasta yhteytesi ja yritä uudelleen."),
    "There's no description yet" : MessageLookupByLibrary.simpleMessage("Kuvausta ei vielä ole"),
    "Title" : MessageLookupByLibrary.simpleMessage("Otsikko"),
    "Title must not be empty" : MessageLookupByLibrary.simpleMessage("Otsikko ei saa olla tyhjä"),
    "To Do" : MessageLookupByLibrary.simpleMessage("Tehtävä"),
