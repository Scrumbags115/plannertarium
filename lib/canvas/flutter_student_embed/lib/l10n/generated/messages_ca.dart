...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static m0(points) => "${points} punts";

  static m1(courseName) => "Tasques pendents de ${courseName}";

  static m2(date, time) => "${date} a les ${time}";

  static m3(date, time) => "Venç el ${date} a les ${time}";

  static m4(month) => "El mes que ve: ${month}";

  static m5(date) => "La setmana que ve a partir del ${date}";

  static m6(points) => "${points} punts possibles";

  static m7(month) => "El mes passat: ${month}";

  static m8(date) => "La setmana passada a partir del ${date}";

  static m9(month) => "Mes de ${month}";
  ...
  static _notInlinedMessages(_) => <String, Function> {
    ...
    "Are You Sure?" : MessageLookupByLibrary.simpleMessage("Segur?"),
    "Are you sure you wish to close this page? Your unsaved changes will be lost." : MessageLookupByLibrary.simpleMessage("Segur que voleu tancar aquesta pàgina? Es perdran els canvis que no hàgiu desat."),
    "Calendar" : MessageLookupByLibrary.simpleMessage("Calendari"),
    "Calendars" : MessageLookupByLibrary.simpleMessage("Calendaris"),
    "Cancel" : MessageLookupByLibrary.simpleMessage("Cancel·la"),
    "Course (optional)" : MessageLookupByLibrary.simpleMessage("Curs (opcional)"),
    ...
    "Do you want to delete this To Do item?" : MessageLookupByLibrary.simpleMessage("Voleu suprimir aquest element de les Tasques pendents?"),
    "Done" : MessageLookupByLibrary.simpleMessage("Fet"),
    "Edit" : MessageLookupByLibrary.simpleMessage("Edita"),
    "Edit To Do" : MessageLookupByLibrary.simpleMessage("Edita les tasques pendents"),
    ...
    "New To Do" : MessageLookupByLibrary.simpleMessage("Noves tasques pendents"),
    ...
    "There was an error deleting this To Do. Please check your connection and try again." : MessageLookupByLibrary.simpleMessage("S'ha produït un error en carregar aquestes tasques pendents. Reviseu la connexió i torneu-ho a provar."),
    "There was an error loading your calendar" : MessageLookupByLibrary.simpleMessage("S'ha produït un error en carregar el calendari"),
    ...
    "There was an error saving this To Do. Please check your connection and try again." : MessageLookupByLibrary.simpleMessage("S'ha produït un error en desar aquestes tasques pendents. Reviseu la connexió i torneu-ho a provar."),
    "There's no description yet" : MessageLookupByLibrary.simpleMessage("Encara no hi ha cap descripció"),
    "Title" : MessageLookupByLibrary.simpleMessage("Títol"),
    "Title must not be empty" : MessageLookupByLibrary.simpleMessage("El títol no pot estar buit"),
    "To Do" : MessageLookupByLibrary.simpleMessage("Tasques pendents"),
